...
/**
 * Managed bean for IntEnz configuration. Some properties apply to
 * intenz-public, others to intenz-ws and others to both of them.
 * @author rafalcan
 *
 */
public interface IntEnzConfigMBean {
    ...
    public abstract int getXmlExportersPoolSize();

    /**
     * Gets the number of XmlExporter instances in a pool used to export IntEnz
     * entries as XML (intenz-ws).
     * @param size the pool size.
     */
	public abstract void setXmlExportersPoolSize(int size);
}
