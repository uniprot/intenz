...
public class IntEnzMessenger {
    ...
    private static IntEnzConfig intenzConfig;

    public static void setIntenzConfig(IntEnzConfig intenzConfig) {
        IntEnzMessenger.intenzConfig = intenzConfig;
    }

    public static void sendError(String className, String errorMessage,
            String userName) {
        Date today = new Date();
        try {
            ...
            InternetAddress fromAddress =
                    new InternetAddress(intenzConfig.getMailFrom());
            message.setFrom(fromAddress);
            InternetAddress[] toAddress =
                    InternetAddress.parse(intenzConfig.getErrorMailTo(), false);
