...
GRANT SELECT ON catalytic_activity_rhea_id TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_alias TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_compound TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_compound_delete TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_compound_update TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_name TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_name_update TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_normalized_exception TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_notchemical TO ENZYME_WEBSERVER;
GRANT SELECT ON chebi_rhea_compound TO ENZYME_WEBSERVER;
GRANT SELECT ON generic TO ENZYME_WEBSERVER;
GRANT SELECT ON polymer TO ENZYME_WEBSERVER;
GRANT SELECT ON polymer_sru TO ENZYME_WEBSERVER;
GRANT SELECT ON residue TO ENZYME_WEBSERVER;
GRANT SELECT ON rhea_compound TO ENZYME_WEBSERVER;
GRANT SELECT ON small_molecule TO ENZYME_WEBSERVER;
