--------------------------------------------------------
--  File created - Tuesday-February-15-2011   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "S_AUDIT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 10460635 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_COMPOUND_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_COMPOUND_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 6393 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_ENZYME_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_ENZYME_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 18447 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_FUTURE_EVENT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_FUTURE_EVENT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1505 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_FUTURE_GROUP_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_FUTURE_GROUP_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1502 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_HISTORY_EVENT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_HISTORY_EVENT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 10067 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_HISTORY_GROUP_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_HISTORY_GROUP_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 10068 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_PUB_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_PUB_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 29623 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_REACTION_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_REACTION_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 28274 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence S_TIMEOUT_ID
--------------------------------------------------------

   CREATE SEQUENCE  "S_TIMEOUT_ID"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1503 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "CV_REACTION_DIRECTIONS" ADD PRIMARY KEY ("CODE") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "REACTIONS_MAP" ADD CONSTRAINT "UQ_REACTIONS_MAP$ID$VIEW$ORDER" UNIQUE ("ENZYME_ID", "WEB_VIEW", "ORDER_IN") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "INTENZ_REACTIONS" MODIFY ("IUBMB" NOT NULL ENABLE);
 
  ALTER TABLE "INTENZ_REACTIONS" ADD PRIMARY KEY ("REACTION_ID") ENABLE;
 
  ALTER TABLE "INTENZ_REACTIONS" ADD UNIQUE ("INTENZ_ACCESSION") ENABLE;
 
  ALTER TABLE "INTENZ_REACTIONS" ADD CONSTRAINT "UQ_INTENZ_REACTIONS$FP" UNIQUE ("FINGERPRINT") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "REACTION_MERGINGS" ADD CONSTRAINT "REACTION_MERGINGS_FK_FROM_ID" FOREIGN KEY ("FROM_ID")
	  REFERENCES "INTENZ_REACTIONS" ("REACTION_ID") ON DELETE CASCADE DISABLE;
