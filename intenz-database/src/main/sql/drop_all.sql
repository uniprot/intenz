...
DROP SEQUENCE S_RHEA_COMPOUND_ID;
...
DROP TABLE CHEBI_ALIAS;
DROP TABLE CHEBI_COMPOUND_DELETE;
DROP TABLE CHEBI_COMPOUND_UPDATE;
DROP TABLE CHEBI_NAME;
DROP TABLE CHEBI_NAME_UPDATE;
DROP TABLE CHEBI_NORMALIZED_EXCEPTION;
DROP TABLE CHEBI_NOTCHEMICAL;
DROP TABLE CHEBI_RHEA_COMPOUND;
DROP TABLE GENERIC;
DROP TABLE GENERIC_AUDIT;
DROP TABLE POLYMER;
DROP TABLE POLYMER_AUDIT;
DROP TABLE POLYMER_SRU;
DROP TABLE RESIDUE;
DROP TABLE SMALL_MOLECULE;
DROP TABLE SMALL_MOLECULE_AUDIT;
DROP TABLE RHEA_COMPOUND;
DROP TABLE CHEBI_COMPOUND;
...
DROP VIEW v_ccu_left;
DROP VIEW v_ccu_right;
...
DROP PROCEDURE "P_INSERT_RHEA_COMPOUND";
