...
<dl>
	<dt><a name="a1"><h3>What is IntEnz?</h3></a>
	</dt>
	...
	<dt><a name="a2"><h3>What is enzyme nomenclature?</h3></a>
	</dt>
	...
	<dt><a name="a3"><h3>Why do we need enzyme nomenclature as a relational database?</h3></a>
	</dt>
	...
	<dt><a name="a4"><h3>What is an EC number?</h3></a>
	</dt>
	...
	<dt><a name="a5"><h3>Incidentally, what does "EC" mean?</h3></a>
	</dt>
	...
	<dt><a name="a6"><h3>Isn't there an official web site of NC-IUBMB with the same data as IntEnz?</h3></a>
	</dt>
	...
	<dt><a name="a7"><h3>Why do we need IntEnz if there is already ENZYME?</h3></a>
	</dt>
	...
	<dt><a name="a8"><h3>Can I download the whole of the IntEnz data?</h3></a>
	</dt>
