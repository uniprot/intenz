 ...
 */
public class DeleteEntryUpdateFWDAction extends ModifyEnzymeFWDAction {
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                               HttpServletResponse response) throws Exception {
    EnzymeDTO enzymeDTO = (EnzymeDTO) request.getSession().getAttribute("enzymeDTO");
    request.setAttribute("title", "Delete Entry " + enzymeDTO.getEc() + " (Update) - IntEnz Curator Application");
