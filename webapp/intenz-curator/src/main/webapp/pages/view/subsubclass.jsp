                    ...
                    <td>
                      <table width="100%" border="0" cellspacing="5">
                        ...
                        <logic:iterate name="subSubclassDTO" id="ghostEntry" property="entries">
                          <tr>
                            <td align="right"><a href="searchId.do?id=<bean:write name="ghostEntry" property="enzymeId"/>&view=INTENZ"><bean:write name="ghostEntry" property="ec"/></td>
                            <logic:equal value="deleted" name="ghostEntry" property="eventClass"><td align="left" class="deleted_transferred" align="left">deleted</td></logic:equal>
                            <logic:equal value="transferred" name="ghostEntry" property="eventClass">
                              <td align="left" class="deleted_transferred" align="left">transferred. <bean:write name="ghostEntry" property="eventNote" filter="false"/>.</td>
                            </logic:equal>
                            ...
                            <logic:equal value="suggested" name="ghostEntry" property="status"><td class="suggested" align="center"></logic:equal>
                            <logic:equal value="proposed" name="ghostEntry" property="status"><td class="proposed" align="center"></logic:equal>
                            <logic:equal value="approved" name="ghostEntry" property="status"><td align="center"></logic:equal>
                            <bean:write name="ghostEntry" property="status"/>
                          </tr>
                        </logic:iterate>
