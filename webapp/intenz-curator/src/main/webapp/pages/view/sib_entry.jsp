  ...
  <table height="100%" width="100%" border="0" cellspacing="8" cellpadding="0">
      ...
      <tr height="100%">
        <td valign="top" align="center">
          ...
          <div id="menuDiv">
            <ul id="menuList">
              <li><a href="searchId.do?id=<bean:write name="sibEnzymeDTO" property="id"/>&view=INTENZ&<%=Constants.TOKEN_KEY%>=<%= request.getAttribute(Constants.TOKEN_KEY) %>" title="IntEnz view of this enzyme containing all available data"><img border="0" width="14" height="12" src="images/blue_bullet.gif"/>&nbsp;IntEnz*</a></li>
              <li><a href="searchId.do?id=<bean:write name="sibEnzymeDTO" property="id"/>&view=IUBMB&<%=Constants.TOKEN_KEY%>=<%= request.getAttribute(Constants.TOKEN_KEY) %>" title="NC-IUBMB view of this enzyme"><img border="0" width="14" height="12" src="images/green_bullet.gif"/>&nbsp;NC-IUBMB</a></li>
