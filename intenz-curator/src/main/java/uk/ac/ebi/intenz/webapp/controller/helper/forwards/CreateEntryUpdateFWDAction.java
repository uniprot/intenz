 ...
 */
public class CreateEntryUpdateFWDAction extends ModifyEnzymeFWDAction {
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
                               HttpServletResponse response) throws Exception {
    EnzymeDTO enzymeDTO = (EnzymeDTO) request.getSession().getAttribute("enzymeDTO");
    request.setAttribute("title", "Create Entry " + enzymeDTO.getEc() + " (Update) - IntEnz Curator Application");
