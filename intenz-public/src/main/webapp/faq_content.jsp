...
<ol>
	...
	<li><a name="a3"><h2>Why do we need enzyme nomenclature as a relational database?</h2></a>
	...
	<li><a name="a4"><h2>What is an EC number?</h2></a>
	...
	<li><a name="a5"><h2>Incidentally, what does "EC" mean?</h2></a>
	...
	<li><a name="a6"><h2>Isn't there an official web site of NC-IUBMB with the same data as IntEnz?</h2></a>
	...
	<li><a name="a7"><h2>Why do we need IntEnz if there is already ENZYME?</h2></a>
	...
	<li><a name="a8"><h2>Can I download the whole of the IntEnz data?</h2></a>
